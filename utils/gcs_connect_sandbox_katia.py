...
class GoogleCloudeStorage:
    ...
    bucket_sandbox = "martech-sandbox"
    ...
    def read_backend_api_method(self):
        API_METHODS_FILE_PATH = "katia/api/google/analytics/main.py"
    ...
    def read_backend_api_utils(self):
        UTILS_FILE_PATH = "katia/api/google/analytics/utils.py"
        contents_utils = self.read_bucket(self.bucket_sandbox, UTILS_FILE_PATH)
